...
# ----------------------------------------------------------------------------
# Packaging script for noandishan board, for Debian-compatible distributions. 
#
...
#    usr/
#    | bin/
#    | | noandishan board <-- actually a symlink to run.sh or noandishan board
#    | share/
#    | | applications/
#    | | | noandishan board.desktop
#    opt/
#    | noandishan board/
#    | | library/
#    | | etc/
...
initializeVariables()
{
  ...
  APPLICATION_NAME="noandishan board"
  APPLICATION_CODE="noandishan board"
  ...
  DESCRIPTION="noandishan board, an interactive white board application"
...
cp resources/linux/noandishan board-ubz.xml $PACKAGE_DIRECTORY/etc/
...
xdg-mime install --mode system /$APPLICATION_PATH/$APPLICATION_CODE/etc/noandishan board-ubz.xml
...
echo "Maintainer: ${APPLICATION_NAME} Developers team <dev@noandishan board.ch>" >> "$CONTROL_FILE"
echo "Homepage: https://github.com/DIP-SEM/noandishan board" >> "$CONTROL_FILE"
