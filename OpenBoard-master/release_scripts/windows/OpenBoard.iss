...
#define ApplicationVersion GetFileVersion("..\..\build\win32\release\product\noandishanboard.exe")
...
AppName=noandishanboard
AppVersion={#ApplicationVersion}
AppVerName=noandishanboard {#ApplicationVersion}
UninstallDisplayName=noandishanboard {#ApplicationVersion}
...
DefaultDirName={pf}\noandishanboard
DefaultGroupName=noandishanboard

#define ProjectRoot GetEnv('PROJECT_ROOT')

OutputDir={#ProjectRoot}\install\win32\
OutputBaseFilename=noandishanboard
SetupIconFile={#ProjectRoot}\resources\win\ico.png
Compression=lzma
...
[Files]
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\microsoft\vcredist_2013.x64.exe"; DestDir:"{tmp}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\microsoft\vcredist_2015_2022.x64.exe"; DestDir:"{tmp}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\microsoft\LAVFilters-0.77.2-Installer.exe"; DestDir:"{tmp}"
Source: "{#ProjectRoot}\build\win32\release\product\*"; DestDir: "{app}"; Flags: ignoreversion recursesubdirs createallsubdirs

;OpenSSL
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\openssl\openssl-3.0.15-win64\bin\libssl-3-x64.dll"; DestDir:"{app}"; Flags: ignoreversion
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\openssl\openssl-3.0.15-win64\bin\libcrypto-3-x64.dll"; DestDir:"{app}"; Flags: ignoreversion
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\openssl\win32\libeay32.dll"; DestDir:"{app}"; Flags: ignoreversion
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\openssl\win32\ssleay32.dll"; DestDir:"{app}"; Flags: ignoreversion

;Qt base dll
;Source: "noandishanboard.exe"; DestDir: "{app}"
...
; Poppler dlls
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\brotlicommon.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\brotlidec.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\bz2.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\freetype.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\jpeg62.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\liblzma.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\libpng16.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\openjp2.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\poppler.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\poppler-cpp.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\tiff.dll"; DestDir: "{app}"
Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\poppler\bin\zlib1.dll"; DestDir: "{app}"

Source: "{#ProjectRoot}\..\noandishanboard-ThirdParty\zlib\1.2.11\bin\zlib.dll"; DestDir:"{app}"; Flags: ignoreversion
...
[Icons]
Name: "{group}\noandishanboard"; Filename: "{app}\noandishanboard.exe"
Name: "{group}\{cm:UninstallProgram,noandishanboard}"; Filename: "{uninstallexe}"
Name: "{commondesktop}\noandishanboard"; Filename: "{app}\noandishanboard.exe"; Tasks: desktopicon
Name: "{userappdata}\Microsoft\Internet Explorer\Quick Launch\noandishanboard"; Filename: "{app}\noandishanboard.exe"; Tasks: quicklaunchicon

[Registry]
Root: HKCR; Subkey: ".ubz"; ValueType: string; ValueName: ""; ValueData: "noandishanboardFile"; Flags: uninsdeletevalue
Root: HKCR; Subkey: "noandishanboardFile"; ValueType: string; ValueName: ""; ValueData: "noandishanboard document"; Flags: uninsdeletekey
Root: HKCR; Subkey: "noandishanboardFile\DefaultIcon"; ValueType: string; ValueName: ""; ValueData: "{app}\noandishanboard.exe,1"
Root: HKCR; Subkey: "noandishanboardFile\shell\open\command"; ValueType: string; ValueName: ""; ValueData: """{app}\noandishanboard.exe"" ""%1"""

Root: HKLM; Subkey: "SOFTWARE\noandishanboard"; ValueType: string; ValueName: "Client application"; ValueData: "{app}\noandishanboard.exe"; Flags: uninsdeletevalue; Check: isProcessorNotX64
Root: HKLM; Subkey: "SOFTWARE\noandishanboard"; ValueType: dword; ValueName: "Transfer mode"; ValueData: "0"; Flags: uninsdeletevalue; Check: isProcessorNotX64
Root: HKLM; Subkey: "SOFTWARE\noandishanboard"; ValueType: dword; ValueName: "EMF: Hide page"; ValueData: "1"; Flags: uninsdeletevalue; Check: isProcessorNotX64
Root: HKLM; Subkey: "SOFTWARE\noandishanboard\Defaults"; ValueType: dword; ValueName: "PDF: Enabled"; ValueData: "1"; Flags: uninsdeletevalue; Check: isProcessorNotX64
...
Root: HKLM; Subkey: "SOFTWARE\Microsoft\Internet Explorer\Low Rights\DragDrop\{{E63D17F8-D9DA-479D-B9B5-0D101A03703B}"; ValueType: string; ValueName: "AppName"; ValueData: "noandishanboard.exe"; Flags: uninsdeletevalue; Check: isProcessorNotX64
...
Root: HKLM64; Subkey: "SOFTWARE\noandishanboard"; ValueType: string; ValueName: "Client application"; ValueData: "{app}\noandishanboard.exe"; Flags: uninsdeletevalue; Check: isProcessorX64
Root: HKLM64; Subkey: "SOFTWARE\noandishanboard"; ValueType: dword; ValueName: "Transfer mode"; ValueData: "0"; Flags: uninsdeletevalue; Check: isProcessorX64
Root: HKLM64; Subkey: "SOFTWARE\noandishanboard"; ValueType: dword; ValueName: "EMF: Hide page"; ValueData: "1"; Flags: uninsdeletevalue; Check: isProcessorX64
Root: HKLM64; Subkey: "SOFTWARE\noandishanboard\Defaults"; ValueType: dword; ValueName: "PDF: Enabled"; ValueData: "1"; Flags: uninsdeletevalue; Check: isProcessorX64
...
Root: HKLM64; Subkey: "SOFTWARE\Wow6432Node\Microsoft\Internet Explorer\Low Rights\DragDrop\{{E63D17F8-D9DA-479D-B9B5-0D101A03703B}"; ValueType: string; ValueName: "AppName"; ValueData: "noandishanboard.exe"; Flags: uninsdeletevalue; Check: isProcessorX64
...
Filename: "{app}\noandishanboard.exe"; Description: "{cm:LaunchProgram,noandishanboard}"; Flags: nowait postinstall skipifsilent 
